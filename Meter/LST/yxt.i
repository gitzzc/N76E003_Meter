...
#line 7 "Code\yxt.c" /0
 ...
 if ( P12 == 1 ){
 low = ((unsigned int)ch<<8)|cl;
 } else {
 high = ((unsigned int)ch<<8)|cl;
 ...
 void YXT_Init(void)
 {
  T2MOD|=0x30;T2MOD&=0xBF;
  T2CON&=~0x01;T2MOD=0x89;
  CAPCON1&=0xFC;CAPCON1|=0x02;CAPCON3&=0xF0;CAPCON0|=0x10;CAPCON2|=0x10;
...
#line 140 "Code\yxt.c" /1
 
 
#line 142 "Code\yxt.c" /0
...
#line 150 "Code\yxt.c" /1
 
 
 
#line 153 "Code\yxt.c" /0
